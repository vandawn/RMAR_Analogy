...
class ComplEx(KBCModel):
    def __init__(
            ...
            init_size: float = 1e-3,
            finetune: bool = False,
            img_info='data/MCNet/img_vec_id_vit.pickle',
            sig_alpha='data/MCNet/rel_MPR_SIG_vit.pickle',
            rel_pd='data/MCNet/rel_MPR_PD_vit_mrp{}.pickle'
    ):
        super(ComplEx, self).__init__()
        self.sizes = sizes
        self.rank = rank
        self.finetune = finetune
        self.analogy_entids = read_txt('data/MCNet/analogy_ent_id')
        self.analogy_relids = read_txt('data/MCNet/analogy_rel_id')
